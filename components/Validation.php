    ...
    class Validation {
        ...
        public function pattern($name){
            ...
            if($name == 'array'){
                ...
                if($this->value != '' && !preg_match($regex, $this->value)){
                    if($name == 'alpha') {
                        $this->errors[$this->name] = "$this->name n'est pas valide(Alphanumérique)";
                    } else {
                        $this->errors[$this->name] = 'Formato campo '.$this->name.' non valid.';
                    }
        ...
        public function required(){
            ...
            if((isset($this->file) && $this->file['error'] == 4) || ($this->value == '' || $this->value == null)){
                $this->errors[$this->name] = 'Le champ '.$this->name.' est oblogatoire.';
            }            
            return $this;
